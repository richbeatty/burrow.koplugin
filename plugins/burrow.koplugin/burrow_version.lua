return {
    VERSION = "0.2.2-alpha",
    DISPLAY_VERSION = "0.2.2 alpha",
    STORE_ENGINE_VERSION = "1.2.0",

    -- Burrow is tested against KOReader 2026.07.1. Older releases are blocked,
    ...
    LAST_TESTED_KOREADER = "2026.07.1",
    LAST_TESTED_KOREADER_NORMALIZED = 202607010000,
