...
function AltBookStatusWidget:genHeader(title)
    local header_title = TextWidget:new {
        text = title,
        face = Font:getFace(burrow_util.good_sans, burrow_util.bookstatus_defaults.header_font_size),
...
function AltBookStatusWidget:genBookInfoGroup()
    ...
    if props.authors then
        authors = burrow_util.formatAuthors(props.authors, 2)
    end
    ...
    local series
    if show_series then
        series = burrow_util.formatSeries(props.series, props.series_index)
    ...
    local author_series_text = burrow_util.formatAuthorSeries(authors, series, series_mode, false)

    -- author(s) and series combined box
    local author_series = TextBoxWidget:new {
        text = author_series_text,
        lang = lang,
        face = Font:getFace(burrow_util.good_serif, burrow_util.bookstatus_defaults.metainfo_font_size),
        width = text_width,
        height_adjust = true,
    ...
    local chapter_title = TextBoxWidget:new {
        text = chapter_text,
        lang = lang,
        face = Font:getFace(burrow_util.good_serif_it, burrow_util.bookstatus_defaults.metainfo_font_size),
        width = text_width,
        height_adjust = true,
        height_overflow_show_ellipsis = true,
        alignment = "center",
    ...
    local book_title = TextBoxWidget:new {
        ...
        height_adjust = true,
        height_overflow_show_ellipsis = true,
        face = Font:getFace(burrow_util.title_serif, burrow_util.bookstatus_defaults.title_font_size),
        alignment = "center",
    }
...
function AltBookStatusWidget:genStatisticsGroup(width)
    ...
    local titles_group = HorizontalGroup:new{
        ...
        CenterContainer:new{
            ...
            TextWidget:new{
                text = _("Days"),
                face = Font:getFace(burrow_util.good_serif_bold, burrow_util.bookstatus_defaults.metainfo_font_size),
            },
        },
        CenterContainer:new{
            dimen = Geom:new{ w = tile_width, h = tile_height },
...
function AltBookStatusWidget:genSummaryGroup(width)
    ...
    self.input_note = ScrollHtmlWidget:new {
        ...
        default_font_size = burrow_util.bookstatus_defaults.description_font_size,
