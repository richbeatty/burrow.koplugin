...
function OPDSBrowser:showDownloadQueue()
    if #self.downloads == 0 then
        UIManager:show(InfoMessage:new {
            text = _("The download queue is empty."),
            timeout = 2,
        })
        return true
    end
