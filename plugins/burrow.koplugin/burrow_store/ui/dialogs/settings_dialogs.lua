-- Settings dialog builders for Burrow Store
-- Extracted from main.lua for better organization and maintainability

local ButtonDialogBuilder = require("burrow_store.utils.button_dialog_builder")
local InfoMessage = require("ui/widget/infomessage")
local SpinWidget = require("ui/widget/spinwidget")
local UIManager = require("ui/uimanager")
local Constants = require("burrow_store.models.constants")
local ImageLoader = require("burrow_store.services.image_loader")
